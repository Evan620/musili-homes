...
export default {
	// darkMode: ["class"], // Disabled - using light mode only
	content: [
		"./pages/**/*.{ts,tsx}",
		"./components/**/*.{ts,tsx}",
		"./app/**/*.{ts,tsx}",
	...
	theme: {
		...
		extend: {
			colors: {
				...
				'pearl-silver': 'hsl(var(--pearl-silver))',
			...
			keyframes: {
				...
				'glow': {
					'0%, 100%': { boxShadow: '0 0 5px hsl(var(--gold-whisper) / 0.5)' },
					'50%': { boxShadow: '0 0 20px hsl(var(--gold-whisper) / 0.8)' }
				},
				'shimmer': {
